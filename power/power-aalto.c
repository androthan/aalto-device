...
static void configure_governor()
{
    ...
    if (strncmp(governor, "ondemand", 8) == 0) {
        ...
        sysfs_write("/sys/devices/system/cpu/cpufreq/ondemand/sampling_rate_min", "10000");
...
struct cm_power_module HAL_MODULE_INFO_SYM = {
    base: {
        common: {
            ...
            name: "YP-GS1 Power HAL",
            author: "The CyanogenMod Project/Androthan",
